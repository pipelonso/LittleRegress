execute as @s[scores={roles=1}] at @s[scores={roles=1}] run execute if score @s[scores={roles=1, peemeter=2..}] onnappy matches 1 run function exec:mechanics/actions/peenappy
execute as @s[scores={roles=1}] at @s[scores={roles=1}] run execute if score @s[scores={roles=1, poometer=2..}] onnappy matches 1 run function exec:mechanics/actions/poonappy
