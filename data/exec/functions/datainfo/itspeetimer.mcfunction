...
execute if score @s[ scores={roles = 1}] peetime matches 10000.. run execute if score @s[scores={roles=1}] peetime matches ..10050 run execute if entity @s[scores={roles=1,onnappy=0}] run function exec:summon/item/summonpee
execute if score @s[ scores={roles = 1}] peetime matches 10000.. run execute if score @s[scores={roles=1}] peetime matches ..10050 run execute if entity @s[scores={roles=1,onnappy=1}] run function exec:mechanics/actions/peenappy
