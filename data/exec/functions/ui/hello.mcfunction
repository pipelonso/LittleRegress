...
execute as @s at @s run execute if score @s roles matches 1 run execute if score @s agree matches 1 run tellraw @s [{"text": "¿Want you to disable furniture and potty mechanics?" , "color": "red"},{"text":" [UNJOIN] ","color":"white","clickEvent":{"action":"run_command","value":"/scoreboard players set @s roles 0"}}]
