...
execute as @s at @s run execute if score @s roles matches 0 run execute if score @s agree matches 1 run tellraw @s [{"text": "¿Want you to join to baby rol?" , "color": "red"},{"text":" [JOIN] ","color":"green","clickEvent":{"action":"run_command","value":"/function exec:conf/setmebaby"}}]
